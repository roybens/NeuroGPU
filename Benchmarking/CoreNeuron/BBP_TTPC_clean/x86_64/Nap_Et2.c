...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nap_Et2 /global/u2/r/roybens/NeuroGPU/Benchmarking/CoreNeuron/BBP_TTPC_clean/x86_64/Nap_Et2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/u2/r/roybens/NeuroGPU/Benchmarking/CoreNeuron/BBP_TTPC_clean/moddir/Nap_Et2.mod";
static const char* nmodl_file_text = 
