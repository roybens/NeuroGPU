...
#define initmodel initmodel__NaTs2_t
#define _net_receive _net_receive__NaTs2_t
#define _net_init _net_init__NaTs2_t
#define nrn_state_launcher nrn_state_NaTs2_t_launcher
#define nrn_cur_launcher nrn_cur_NaTs2_t_launcher
...
#define _dlist1 _dlist1_NaTs2_t
int* _dlist1;
