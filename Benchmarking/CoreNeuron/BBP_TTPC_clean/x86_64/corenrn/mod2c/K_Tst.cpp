...
#define initmodel initmodel__K_Tst
#define _net_receive _net_receive__K_Tst
#define _net_init _net_init__K_Tst
#define nrn_state_launcher nrn_state_K_Tst_launcher
#define nrn_cur_launcher nrn_cur_K_Tst_launcher
#define nrn_jacob_launcher nrn_jacob_K_Tst_launcher 
#define rates rates_K_Tst 
#define states states_K_Tst 
...
#define t _nt->_t
#define dt _nt->_dt
#define gK_Tstbar _p[0*_STRIDE]
#define ik _p[1*_STRIDE]
#define gK_Tst _p[2*_STRIDE]
...
#define _slist1 _slist1_K_Tst
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_K_Tst
int* _dlist1;
