...
#define initmodel initmodel__Nap_Et2
#define _net_receive _net_receive__Nap_Et2
#define _net_init _net_init__Nap_Et2
#define nrn_state_launcher nrn_state_Nap_Et2_launcher
#define nrn_cur_launcher nrn_cur_Nap_Et2_launcher
#define nrn_jacob_launcher nrn_jacob_Nap_Et2_launcher 
#define rates rates_Nap_Et2 
#define states states_Nap_Et2 
...
#define _slist1 _slist1_Nap_Et2
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Nap_Et2
int* _dlist1;
