...
#define initmodel initmodel__Ih
#define _net_receive _net_receive__Ih
#define _net_init _net_init__Ih
#define nrn_state_launcher nrn_state_Ih_launcher
#define nrn_cur_launcher nrn_cur_Ih_launcher
#define nrn_jacob_launcher nrn_jacob_Ih_launcher 
#define rates rates_Ih 
#define states states_Ih 
...
#define ehcn ehcn_Ih
 double ehcn = -45;
 #pragma acc declare copyin (ehcn)
 
static void _acc_globals_update() {
 #pragma acc update device (ehcn) if(nrn_threads->compute_gpu)
 }
...
#define _slist1 _slist1_Ih
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Ih
int* _dlist1;
