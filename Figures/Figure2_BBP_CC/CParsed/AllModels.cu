// Automatically generated CU for E:\GitHub\NeuroGPU\Figures\Figure2_BBP_CC./runModel.hoc
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
// Declarations:
__device__ void Curates_Ca(MYFTYPE v,MYFTYPE gCabar_Ca,MYFTYPE &hAlpha,MYFTYPE &hBeta,MYFTYPE &hInf,MYFTYPE &hTau,MYFTYPE &mAlpha,MYFTYPE &mBeta,MYFTYPE &mInf,MYFTYPE &mTau);
...
__device__ void Cutrates_KdShu2007(MYFTYPE v,MYFTYPE gkbar_KdShu2007,MYFTYPE ek_KdShu2007,MYFTYPE vhalfm_KdShu2007,MYFTYPE km_KdShu2007,MYFTYPE vhalfh_KdShu2007,MYFTYPE kh_KdShu2007,MYFTYPE q10_KdShu2007,MYFTYPE &hinf,MYFTYPE &htau,MYFTYPE &minf,MYFTYPE &mtau);
...
__device__ void Cutrates_KdShu2007(MYFTYPE v,MYFTYPE gkbar_KdShu2007,MYFTYPE ek_KdShu2007,MYFTYPE vhalfm_KdShu2007,MYFTYPE km_KdShu2007,MYFTYPE vhalfh_KdShu2007,MYFTYPE kh_KdShu2007,MYFTYPE q10_KdShu2007,MYFTYPE &hinf,MYFTYPE &htau,MYFTYPE &minf,MYFTYPE &mtau) {
   MYFTYPE qt ;
 qt = powf( q10_KdShu2007 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   minf = 1.0 - 1.0 / ( 1.0 + exp ( ( v - vhalfm_KdShu2007 ) / km_KdShu2007 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( v - vhalfh_KdShu2007 ) / kh_KdShu2007 ) ) ;
   mtau = 0.6 ;
   htau = 1500.0 ;
}
__device__ void Curates_Nap_Et2(MYFTYPE v,MYFTYPE gNap_Et2bar_Nap_Et2,MYFTYPE &hAlpha,MYFTYPE &hBeta,MYFTYPE &hInf,MYFTYPE &hTau,MYFTYPE &mAlpha,MYFTYPE &mBeta,MYFTYPE &mInf,MYFTYPE &mTau) {
...
Curates_Ca(v,gCabar_Ca,hAlpha,hBeta,hInf,hTau,mAlpha,mBeta,mInf,mTau);
   m = mInf;
   h = hInf;
};
...
MYFTYPE hinf,htau,minf,mtau;
Cutrates_KdShu2007(v,gkbar_KdShu2007,ek_KdShu2007,vhalfm_KdShu2007,km_KdShu2007,vhalfh_KdShu2007,kh_KdShu2007,q10_KdShu2007,hinf,htau,minf,mtau);
   m=minf  ;
   h=hinf  ;
};
...
MYFTYPE gk, ik;
MYFTYPE ;
   ik = gkbar_KdShu2007 * m * h * ( v - ek_KdShu2007 ) ;
sumCurrents+= ik;
};
