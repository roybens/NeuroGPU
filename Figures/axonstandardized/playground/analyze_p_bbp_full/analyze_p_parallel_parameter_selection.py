...
def optimize(stim_name_list, pin_score_dict, collapsed_sensitivity_dict):
	...
	obj = construct_objective(score_mat, sensitivity_mat, param_select_vec=[9], obj_comb_vec=[1, 1])
...
if COMM.rank == 0:
	...
	opt_result_hdf5 = h5py.File(optimization_results_path+'opt_result_single_stim_with_sensitivity_mainen_full_1_1_40_stims_10.hdf5', 'w')
