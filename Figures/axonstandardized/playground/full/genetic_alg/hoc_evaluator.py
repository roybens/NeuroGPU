...
run_volts_path = '../run_volts_bbp_calcium/'
paramsCSV = run_volts_path+'params/params_bbp_calcium.csv'
orig_params = h5py.File(run_volts_path+'params/params_bbp_calcium.hdf5', 'r')['orig_calcium'][0]
scores_path = '../scores/'
objectives_file = h5py.File('./objectives/multi_stim_without_sensitivity_bbp_calcium_1_0_20_stims.hdf5', 'r')
opt_weight_list = objectives_file['opt_weight_list'][:]
opt_stim_name_list = objectives_file['opt_stim_name_list'][:]
score_function_ordered_list = objectives_file['ordered_score_function_list'][:]
stims_path = run_volts_path+'/stims/stims_full.hdf5'
