...
def construct_objective(score_mat, sensitivity_mat, obj_comb_vec=[2, 1, 1]):
...
def optimize(stim_name_list, pin_score_dict, collapsed_sensitivity_dict):
	...
	obj = construct_objective(score_mat, sensitivity_mat, [200, 1, 1])
...
if COMM.rank == 0:
	...
	opt_result_hdf5 = h5py.File(optimization_results_path+'opt_result_single_stim_with_sensitivity_200_1_1.hdf5', 'w')
