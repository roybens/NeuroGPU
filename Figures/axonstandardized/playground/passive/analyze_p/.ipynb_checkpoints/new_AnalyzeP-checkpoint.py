...
def construct_objective(score_mat, sensitivity_mat, param_select_vec, obj_comb_vec = obj_comb_vec):
...
def optimize(stim_name_list, subset_list=None, min_bound = 0, max_bound = 100, obj_comb_vec = obj_comb_vec):
    ...
    obj = construct_objective(score_mat, sensitivity_mat, obj_comb_vec)

    return minimizeCompass(obj, bounds=bound, x0=initial_guess, deltainit = 100, deltatol=0.1, paired=False), score_mat, obj
