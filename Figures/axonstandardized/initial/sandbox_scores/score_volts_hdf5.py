...
params_file_name = '../../../../run_volts_mainen_passive_hdf5/params/params_mainen_passive.hdf5'
volts_path = '../../../../run_volts_mainen_passive_hdf5/volts/'
output_path = '../../../scores/'

volts_name_list = sorted(os.listdir(volts_path))

k=int(sys.argv[1]) 
curr_volts_name = volts_name_list[k-1]
