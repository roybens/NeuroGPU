...
def construct_objective(score_mat, obj_comb_vec=[1, 0, 0]):
...
def optimize(stim_name_list, pin_score_dict):
	...
	obj = construct_objective(score_mat, [1, 0, 0])
...
if COMM.rank == 0:
	...
	opt_result_hdf5 = h5py.File(optimization_results_path+'opt_result_single_stim_without_sensitivity_' + peeling +'.hdf5', 'w')
