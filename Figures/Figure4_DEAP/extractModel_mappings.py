...
import time
from extractModel_all_params import run_extract
from extractModel_for_mapping import run_extract_for_mapping
import importlib
...
params_file =       f'./{params_dir}/formap.csv'                    # 12 parameters
...
def main():
    run_extract_for_mapping() # create params template and allparamsreference
    time.sleep(5)
