...
#define init_state_macro(stateInd,segmentInd) InitStatesM[NeuronID*perThreadStateMSize + stateInd*InMat.NComps+cSegToComp[segmentInd] ]	;
	...
	for (int count = 1; count < NILP + 1; count++) {
	if(cBoolModel[PIdx[count] +0*NSEG]){CuInitModel_Ca_HVA(v[count],state_macro(0,count) ,state_macro(1,count) ,param_macro(0, PIdx[count]) , ica[count] ,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +1*NSEG]){CuInitModel_Ca_LVAst(v[count],state_macro(2,count) ,state_macro(3,count) ,param_macro(1, PIdx[count]) , ica[count] ,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +2*NSEG]){CuInitModel_CaDynamics_E2(v[count],cai[count]  ,param_macro(2, PIdx[count]) ,param_macro(3, PIdx[count]) ,param_macro(4, PIdx[count]) ,param_macro(5, PIdx[count]) , ica[count] ,eca[count] );}if(cBoolModel[PIdx[count] +3*NSEG]){CuInitModel_Ih(v[count],state_macro(5,count) ,param_macro(6, PIdx[count]) ,param_macro(7, PIdx[count]) );}if(cBoolModel[PIdx[count] +4*NSEG]){CuInitModel_Im(v[count],state_macro(6,count) ,param_macro(8, PIdx[count]) );}if(cBoolModel[PIdx[count] +5*NSEG]){CuInitModel_K_Pst(v[count],state_macro(7,count) ,state_macro(8,count) ,param_macro(9, PIdx[count]) );}if(cBoolModel[PIdx[count] +6*NSEG]){CuInitModel_K_Tst(v[count],state_macro(9,count) ,state_macro(10,count) ,param_macro(10, PIdx[count]) );}if(cBoolModel[PIdx[count] +7*NSEG]){CuInitModel_na12(v[count],state_macro(11,count) ,state_macro(12,count) ,state_macro(13,count) ,param_macro(11, PIdx[count]) ,param_macro(12, PIdx[count]) ,param_macro(13, PIdx[count]) );}if(cBoolModel[PIdx[count] +8*NSEG]){CuInitModel_na16(v[count],state_macro(14,count) ,state_macro(15,count) ,state_macro(16,count) ,param_macro(14, PIdx[count]) ,param_macro(15, PIdx[count]) ,param_macro(16, PIdx[count]) );}if(cBoolModel[PIdx[count] +9*NSEG]){CuInitModel_Nap_Et2(v[count],state_macro(17,count) ,state_macro(18,count) ,param_macro(17, PIdx[count]) );}if(cBoolModel[PIdx[count] +10*NSEG]){CuInitModel_NaTa_t(v[count],state_macro(19,count) ,state_macro(20,count) ,param_macro(18, PIdx[count]) );}if(cBoolModel[PIdx[count] +11*NSEG]){CuInitModel_NaTs2_t(v[count],state_macro(21,count) ,state_macro(22,count) ,param_macro(19, PIdx[count]) );}if(cBoolModel[PIdx[count] +12*NSEG]){CuInitModel_pas(v[count],param_macro(20, PIdx[count]) ,param_macro(21, PIdx[count]) );}if(cBoolModel[PIdx[count] +13*NSEG]){CuInitModel_SK_E2(v[count],state_macro(23,count) ,param_macro(22, PIdx[count]) ,param_macro(23, PIdx[count]) , cai[count] ,eca[count] );}if(cBoolModel[PIdx[count] +14*NSEG]){CuInitModel_SKv3_1(v[count],state_macro(24,count) ,param_macro(24, PIdx[count]) );}
	}
	...
	for (int i = 0; i<Nt; i++) {
		...
		for (int count = 1; count < NILP + 1; count++) {
		   if(cBoolModel[PIdx[count] +0*NSEG]){CuBreakpointModel_Ca_HVA(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(0,count) ,state_macro(1,count) ,param_macro(0, PIdx[count]) , temp,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +1*NSEG]){CuBreakpointModel_Ca_LVAst(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(2,count) ,state_macro(3,count) ,param_macro(1, PIdx[count]) , temp,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +2*NSEG]){CuBreakpointModel_CaDynamics_E2(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,cai[count]  ,param_macro(2, PIdx[count]) ,param_macro(3, PIdx[count]) ,param_macro(4, PIdx[count]) ,param_macro(5, PIdx[count]) , temp,eca[count] );}if(cBoolModel[PIdx[count] +3*NSEG]){CuBreakpointModel_Ih(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(5,count) ,param_macro(6, PIdx[count]) ,param_macro(7, PIdx[count]) );}if(cBoolModel[PIdx[count] +4*NSEG]){CuBreakpointModel_Im(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(6,count) ,param_macro(8, PIdx[count]) );}if(cBoolModel[PIdx[count] +5*NSEG]){CuBreakpointModel_K_Pst(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(7,count) ,state_macro(8,count) ,param_macro(9, PIdx[count]) );}if(cBoolModel[PIdx[count] +6*NSEG]){CuBreakpointModel_K_Tst(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(9,count) ,state_macro(10,count) ,param_macro(10, PIdx[count]) );}if(cBoolModel[PIdx[count] +7*NSEG]){CuBreakpointModel_na12(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(11,count) ,state_macro(12,count) ,state_macro(13,count) ,param_macro(11, PIdx[count]) ,param_macro(12, PIdx[count]) ,param_macro(13, PIdx[count]) );}if(cBoolModel[PIdx[count] +8*NSEG]){CuBreakpointModel_na16(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(14,count) ,state_macro(15,count) ,state_macro(16,count) ,param_macro(14, PIdx[count]) ,param_macro(15, PIdx[count]) ,param_macro(16, PIdx[count]) );}if(cBoolModel[PIdx[count] +9*NSEG]){CuBreakpointModel_Nap_Et2(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(17,count) ,state_macro(18,count) ,param_macro(17, PIdx[count]) );}if(cBoolModel[PIdx[count] +10*NSEG]){CuBreakpointModel_NaTa_t(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(19,count) ,state_macro(20,count) ,param_macro(18, PIdx[count]) );}if(cBoolModel[PIdx[count] +11*NSEG]){CuBreakpointModel_NaTs2_t(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(21,count) ,state_macro(22,count) ,param_macro(19, PIdx[count]) );}if(cBoolModel[PIdx[count] +12*NSEG]){CuBreakpointModel_pas(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,param_macro(20, PIdx[count]) ,param_macro(21, PIdx[count]) );}if(cBoolModel[PIdx[count] +13*NSEG]){CuBreakpointModel_SK_E2(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(23,count) ,param_macro(22, PIdx[count]) ,param_macro(23, PIdx[count]) , cai[count] ,eca[count] );}if(cBoolModel[PIdx[count] +14*NSEG]){CuBreakpointModel_SKv3_1(sumCurrentsDv[count] , sumConductivityDv[count] ,v[count] +0.001,state_macro(24,count) ,param_macro(24, PIdx[count]) );}
		  if(cBoolModel[PIdx[count] +0*NSEG]){CuBreakpointModel_Ca_HVA(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(0,count) ,state_macro(1,count) ,param_macro(0, PIdx[count]) , ica[count] ,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +1*NSEG]){CuBreakpointModel_Ca_LVAst(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(2,count) ,state_macro(3,count) ,param_macro(1, PIdx[count]) , ica[count] ,eca[count] ,cai[count] );}if(cBoolModel[PIdx[count] +2*NSEG]){CuBreakpointModel_CaDynamics_E2(sumCurrents[count] , sumConductivity[count],v[count] ,cai[count]  ,param_macro(2, PIdx[count]) ,param_macro(3, PIdx[count]) ,param_macro(4, PIdx[count]) ,param_macro(5, PIdx[count]) , ica[count] ,eca[count] );}if(cBoolModel[PIdx[count] +3*NSEG]){CuBreakpointModel_Ih(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(5,count) ,param_macro(6, PIdx[count]) ,param_macro(7, PIdx[count]) );}if(cBoolModel[PIdx[count] +4*NSEG]){CuBreakpointModel_Im(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(6,count) ,param_macro(8, PIdx[count]) );}if(cBoolModel[PIdx[count] +5*NSEG]){CuBreakpointModel_K_Pst(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(7,count) ,state_macro(8,count) ,param_macro(9, PIdx[count]) );}if(cBoolModel[PIdx[count] +6*NSEG]){CuBreakpointModel_K_Tst(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(9,count) ,state_macro(10,count) ,param_macro(10, PIdx[count]) );}if(cBoolModel[PIdx[count] +7*NSEG]){CuBreakpointModel_na12(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(11,count) ,state_macro(12,count) ,state_macro(13,count) ,param_macro(11, PIdx[count]) ,param_macro(12, PIdx[count]) ,param_macro(13, PIdx[count]) );}if(cBoolModel[PIdx[count] +8*NSEG]){CuBreakpointModel_na16(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(14,count) ,state_macro(15,count) ,state_macro(16,count) ,param_macro(14, PIdx[count]) ,param_macro(15, PIdx[count]) ,param_macro(16, PIdx[count]) );}if(cBoolModel[PIdx[count] +9*NSEG]){CuBreakpointModel_Nap_Et2(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(17,count) ,state_macro(18,count) ,param_macro(17, PIdx[count]) );}if(cBoolModel[PIdx[count] +10*NSEG]){CuBreakpointModel_NaTa_t(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(19,count) ,state_macro(20,count) ,param_macro(18, PIdx[count]) );}if(cBoolModel[PIdx[count] +11*NSEG]){CuBreakpointModel_NaTs2_t(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(21,count) ,state_macro(22,count) ,param_macro(19, PIdx[count]) );}if(cBoolModel[PIdx[count] +12*NSEG]){CuBreakpointModel_pas(sumCurrents[count] , sumConductivity[count],v[count] ,param_macro(20, PIdx[count]) ,param_macro(21, PIdx[count]) );}if(cBoolModel[PIdx[count] +13*NSEG]){CuBreakpointModel_SK_E2(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(23,count) ,param_macro(22, PIdx[count]) ,param_macro(23, PIdx[count]) , cai[count] ,eca[count] );}if(cBoolModel[PIdx[count] +14*NSEG]){CuBreakpointModel_SKv3_1(sumCurrents[count] , sumConductivity[count],v[count] ,state_macro(24,count) ,param_macro(24, PIdx[count]) );}
...
for (int count = 1; count < NILP + 1; count++) {
	  if(cBoolModel[PIdx[count] +0*NSEG]){CuDerivModel_Ca_HVA(dt, v[count],state_macro(0,count) ,state_macro(1,count) ,param_macro(0, PIdx[count]) , ica[count] );}if(cBoolModel[PIdx[count] +1*NSEG]){CuDerivModel_Ca_LVAst(dt, v[count],state_macro(2,count) ,state_macro(3,count) ,param_macro(1, PIdx[count]) , ica[count] );}if(cBoolModel[PIdx[count] +2*NSEG]){CuDerivModel_CaDynamics_E2(dt, v[count],cai[count]  ,param_macro(2, PIdx[count]) ,param_macro(3, PIdx[count]) ,param_macro(4, PIdx[count]) ,param_macro(5, PIdx[count]) , ica[count] ,eca[count] );}if(cBoolModel[PIdx[count] +3*NSEG]){CuDerivModel_Ih(dt, v[count],state_macro(5,count) ,param_macro(6, PIdx[count]) ,param_macro(7, PIdx[count]) );}if(cBoolModel[PIdx[count] +4*NSEG]){CuDerivModel_Im(dt, v[count],state_macro(6,count) ,param_macro(8, PIdx[count]) );}if(cBoolModel[PIdx[count] +5*NSEG]){CuDerivModel_K_Pst(dt, v[count],state_macro(7,count) ,state_macro(8,count) ,param_macro(9, PIdx[count]) );}if(cBoolModel[PIdx[count] +6*NSEG]){CuDerivModel_K_Tst(dt, v[count],state_macro(9,count) ,state_macro(10,count) ,param_macro(10, PIdx[count]) );}if(cBoolModel[PIdx[count] +7*NSEG]){CuDerivModel_na12(dt, v[count],state_macro(11,count) ,state_macro(12,count) ,state_macro(13,count) ,param_macro(11, PIdx[count]) ,param_macro(12, PIdx[count]) ,param_macro(13, PIdx[count]) );}if(cBoolModel[PIdx[count] +8*NSEG]){CuDerivModel_na16(dt, v[count],state_macro(14,count) ,state_macro(15,count) ,state_macro(16,count) ,param_macro(14, PIdx[count]) ,param_macro(15, PIdx[count]) ,param_macro(16, PIdx[count]) );}if(cBoolModel[PIdx[count] +9*NSEG]){CuDerivModel_Nap_Et2(dt, v[count],state_macro(17,count) ,state_macro(18,count) ,param_macro(17, PIdx[count]) );}if(cBoolModel[PIdx[count] +10*NSEG]){CuDerivModel_NaTa_t(dt, v[count],state_macro(19,count) ,state_macro(20,count) ,param_macro(18, PIdx[count]) );}if(cBoolModel[PIdx[count] +11*NSEG]){CuDerivModel_NaTs2_t(dt, v[count],state_macro(21,count) ,state_macro(22,count) ,param_macro(19, PIdx[count]) );}if(cBoolModel[PIdx[count] +12*NSEG]){}if(cBoolModel[PIdx[count] +13*NSEG]){CuDerivModel_SK_E2(dt, v[count],state_macro(23,count) ,param_macro(22, PIdx[count]) ,param_macro(23, PIdx[count]) , cai[count] ,eca[count] );}if(cBoolModel[PIdx[count] +14*NSEG]){CuDerivModel_SKv3_1(dt, v[count],state_macro(24,count) ,param_macro(24, PIdx[count]) );}
		}
