...
import shutil
import time
os.chdir("../Figures/Figure2_BBP_TTPC/")
...
model_dir = '../Figures/Figure2_BBP_TTPC/'
data_dir = '../Figures/Figure2_BBP_TTPC/Data'
param_file = '../Figures/Figure2_BBP_TTPC/params/formap.csv'
run_dir = '../Figures/Figure2_BBP_TTPC/'
vs_fn = run_dir + 'Data/VHotP.dat'
params_table =  '../Figures/Figure4_DEAP/params/opt_table.csv'
...
def init_nrngpu():
    ...
    global ptarget
    global orig_volts
    modelFile = os.path.join(model_dir,"runModel.hoc")
