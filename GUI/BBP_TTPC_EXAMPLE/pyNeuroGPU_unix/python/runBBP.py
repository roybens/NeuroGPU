...
## set up filepaths
paramsCSV = '../params/params_explor10000bigK.csv'
orig_params = np.genfromtxt('../params/params.csv')
data_dir = '../Data/'
run_dir = '../bin'
...
def main():
    ...
    new_param_values =  np.genfromtxt(paramsCSV, delimiter=',')
    import pdb; pdb.set_trace()
    param_values = np.repeat(orig_params.reshape(-1,1), len(new_param_values), axis=1).T
    param_values[:,0] = new_param_values[:,0]
    param_values[:,2] = new_param_values[:,2]
